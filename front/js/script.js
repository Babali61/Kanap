// Appel de l'api avec fetch puis promesse JSON puis fonction post intégrant un output de valeur null avec une autre fonction forEach ( post ) qui parcours les élements du tableau et qui affiche les éléments du tableau en appelant les valeurs de JSON avec ${nomFonction.nomTableau}. 
